...
@if($user->isSuperAdmin())
    ...
    <a href="{{ route('admin.users.index') }}"
       class="{{ request()->routeIs('admin.users.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('admin.sms-settings.index') }}"
       class="{{ request()->routeIs('admin.sms-settings.*') || request()->routeIs('admin.sms-logs.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
@if($user->isMarketOwner())
    <a href="{{ route('market-owner.dashboard') }}"
       class="{{ request()->routeIs('market-owner.dashboard') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
        </svg>
    ...
    <a href="{{ route('market-owner.shops.index') }}"
       class="{{ request()->routeIs('market-owner.shops.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
        </svg>
    ...
    <a href="{{ route('market-owner.shop-owners.index') }}"
       class="{{ request()->routeIs('market-owner.shop-owners.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
        </svg>
        {{ __('messages.nav.shop_owners') }}
    </a>

    <a href="{{ route('market-owner.staff.index') }}"
       class="{{ request()->routeIs('market-owner.staff.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('market-owner.invoices.index') }}"
       class="{{ request()->routeIs('market-owner.invoices.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('market-owner.payments.index') }}"
       class="{{ request()->routeIs('market-owner.payments.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('market-owner.complaints.index') }}"
       class="{{ request()->routeIs('market-owner.complaints.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('market-owner.notices.index') }}"
       class="{{ request()->routeIs('market-owner.notices.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('market-owner.reports.index') }}"
       class="{{ request()->routeIs('market-owner.reports.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
@if($user->isCollector())
    <a href="{{ route('collector.dashboard') }}"
       class="{{ request()->routeIs('collector.dashboard') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
        </svg>
        {{ __('messages.dashboard') }}
    ...
    <a href="{{ route('collector.shops.index') }}"
       class="{{ request()->routeIs('collector.shops.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
        </svg>
        {{ __('messages.nav.shops') }}
    ...
    <a href="{{ route('collector.payments.index') }}"
       class="{{ request()->routeIs('collector.payments.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
        </svg>
        {{ __('messages.nav.payments') }}
...
@if($user->isShopOwner())
    <a href="{{ route('shop-owner.dashboard') }}"
       class="{{ request()->routeIs('shop-owner.dashboard') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
        </svg>
        {{ __('messages.dashboard') }}
    ...
    <a href="{{ route('shop-owner.invoices.index') }}"
       class="{{ request()->routeIs('shop-owner.invoices.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
        </svg>
        {{ __('messages.nav.invoices') }}
    ...
    <a href="{{ route('shop-owner.complaints.index') }}"
       class="{{ request()->routeIs('shop-owner.complaints.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
        </svg>
        {{ __('messages.nav.complaints') }}
    ...
    <a href="{{ route('shop-owner.notices.index') }}"
       class="{{ request()->routeIs('shop-owner.notices.*') ? 'nav-link-active' : 'nav-link' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/>
        </svg>
        {{ __('messages.nav.notices') }}
...
{{-- Help (all roles) --}}
<a href="{{ route('manual') }}" target="_blank" rel="noopener" class="nav-link mt-4 border-t border-white/60 pt-4">
    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
    </svg>
    {{ __('messages.nav.manual') }}
</a>
